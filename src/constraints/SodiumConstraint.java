...
/**
 * Constraint for Sodium content. Most work is done in base class.
 * 
 * @author jernlas
 */
public class SodiumConstraint extends MeasurementConstraint {

   public SodiumConstraint(Measurement minValue, Measurement maxValue) {
